...
**Electric Capital opener (data-first fund — lead with the audit culture, not the product):** "You built the industry's habit of measuring what's actually happening (the Developer Report), so I'll lead with our data: 37 machine-audited days, 95 settled positions, $4.75M notional, zero peak net exposure — one-tap options protection, in production on Hyperliquid." Then standard v2 body.
...
**Current scorecard block (Aug 28 — replaces all older stats):** 37 days · 95 settled · $4.75M notional · client all-in +4.8 bps · 81% days positive · 100% oracle-verified/reconciled · zero peak net exposure · 1 of 98 opens refused (not priceable) · capital drag 0.036 bps/day vs ~1.7 bps/day production fee. Regime gate currently HALT by design (live |move| 5.3% ≥ 2.55%) — a quiet dashboard IS the discipline exhibit.
