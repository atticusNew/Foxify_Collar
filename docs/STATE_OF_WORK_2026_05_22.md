...
- **Bullish E3 (4-leg [DB] spread atomicity) microtest** — script DRAFTED, ready to run on shadow. `services/api/scripts/probes/bullish_spread_e2e_microtest.sh` (commit `b8b1b7f`).
