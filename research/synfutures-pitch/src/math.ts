/**
 * Self-contained BS / spread math for the SynFutures pitch backtest.
 *
 * Foxify-clean: no imports from any pilot path. No Foxify-specific
 * calibration constants — vol params are explicit per call.
 */
...
export function putSpreadPayout(
  ...
  S_entry: number, S_expiry: number, notional: number,
): number {
...
/**
 * Annualised realized vol from daily log-returns.
 */
